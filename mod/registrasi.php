        ...
        <div class="section mb-5 p-2">
            <form id="form-registrasi">
                ...
                <div class="form-links mt-2">
                    ...
                    <div>
                        <a class="btn btn-secondary disabled" href="forgot"><i class="fa fa-key"></i> Reset Password</a>
                    </div>
                </div>

                <div class="form-button-group transparent">
                   <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-user-plus"></i> Register</button>
                   <a href="oauth/google" class="btn btn-secondary btn-block disabled"><ion-icon name="logo-google"></ion-icon> Register with Google</a>
                </div>
