	        				...
	        				<div class="row h-100 justify-content-center align-items-center">
	        					<div class="col-lg-5">
	        						<div class="hero-content text-center text-white">
	        							...
	        							<i aria-hidden="true" class="fa fa-check-circle"></i> Powered by IyaiCoding Group
	        						</div>
	        					</div>
	        					<div class="col-lg-6">
	        						<img style="border-radius: 30px;" src="<?php echo $site_url; ?>/content/logo/#" class="img-fluid">
	        					</div>
	        				</div>
	        			</div>
	        		</div>
